<picture>
  ...
  <img src="./assets/readme/code/boot-still.svg" width="100%" alt="Eclipxse. Mario, full-stack developer and toolmaker. Vector lettering and an ASCII torus.">
</picture>
...
<picture>
  ...
  <img src="./assets/readme/code/music-still.svg" width="100%" alt="Eclipxse Music. An animated audio signal for the Windows music project.">
</picture>
</a>
...
<picture>
  ...
  <img src="./assets/readme/code/portfolio-still.svg" width="100%" alt="Eclipxse.in. A rotating wireframe made from mathematical paths.">
</picture>
</a>
...
<picture>
  ...
  <img src="./assets/readme/code/signoff-still.svg" width="100%" alt="Terminal prompt: make something worth opening.">
</picture>

<sub>[Profile code](./scripts/build-profile.mjs) &nbsp;·&nbsp; [Animated edition](./README.md)</sub>
